...
export default function Stacks() {
    ...
    return (
        <div className="text-center my-3 py-3 bg-slate-700/30 rounded-lg ring-2 ring-purple-800/50 shadow-lg shadow-purple-500">
            <h1 className="my-2">Primary Toolbelt</h1>
            <div className="grid grid-cols-3 md:grid-cols-4 xl:grid-cols-7 gap-4">
