...
export default function Stacks() {
    ...
    return (
        <div className="group/container text-center my-3 pt-3 pb-6 bg-lavender-macaron/15 hover:bg-lavender-macaron/30 rounded-lg ring-2 ring-lavender-macaron/50 hover:ring-lavender-macaron shadow-xl transition-all ease-in-out duration-300">
